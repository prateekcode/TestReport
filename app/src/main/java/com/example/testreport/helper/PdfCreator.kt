...
object PdfCreator {
    ...
    fun createTestReportPdf(
        ...
        newCanvas.drawText("------------------>  End of Report  <------------------", 60f, 200F, textPaintPatient)
        ...
        textPaintPatient.isSubpixelText = true
        textPaintPatient.color = ContextCompat.getColor(context, R.color.black)
        newCanvas.drawText("Pathologist Signature", 170F, 330F, textPaintPatient)
        ...
        newCanvas.drawText("Dr. Ganesh Hansram", 170F, 350F, textPaintPatient)
        newCanvas.drawText("Radiologist  |  MD", 170F, 355F, textPaintPatient)
        newCanvas.drawText("3542656", 190F, 360F, textPaintPatient)
        textPaintPatient.typeface = customTypeFace7
        newCanvas.drawText("Reg. No.", 170F, 360F, textPaintPatient)
       ...
       // Footer2
        ...
        textPaint3.letterSpacing = 0.001f
        textPaint3.isAntiAlias = true
        textPaint3.isLinearText = true
        textPaint3.isSubpixelText = true
